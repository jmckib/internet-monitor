...
(function() {
  window.draw_speed_chart = function(data) {
    ...
    svg.append('g').attr('class', 'y axis').call(yAxis).append('text').attr('transform', 'rotate(-90)').attr('y', -1 * (margin.left - 12)).attr('dy', '.71em').attr('x', -1 * height / 2).style('text-anchor', 'middle').text('Megabytes/s');
